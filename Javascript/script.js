...
function calculateResult(){
    ...
    if (rightAnswer1=="Division by zero"){marks+=10};
    if (rightAnswer2=="Object Oriented"){marks+=10};
    if (rightAnswer3=="Immediate if"){marks+=10};
    if (rightAnswer4=="Block that combines a number of statements into a single compound statement"){marks+=10};
    if (rightAnswer5=="Ignores the statemt"){marks+=10};
    if (rightAnswer6=="Declaration statements"){marks+=10};
    if (rightAnswer7=="The local element"){marks+=10};
    if (rightAnswer8=="Function/method"){marks+=10};
    if (rightAnswer9=="Mutable variable"){marks+=10};
    if (rightAnswer10=="Displays Infinity"){marks+=10}
